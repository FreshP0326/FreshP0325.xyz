...
interface PostPageShellProps extends React.HTMLAttributes<HTMLDivElement> {
  currentPath?: string;
  locale: string;
  tocItems: TocItem[];
}

export function PostPageShell({ children, className, currentPath, locale, tocItems, ...props }: PostPageShellProps) {
